...
MAX_GENERATIONS = 32#1000
GAMES_PER_GENERATION = 25#100
TRAINING_UPDATES_PER_GENERATION = 50
NUM_EVAL_GAMES = 16#50
EVAL_WIN_THRESHOLD = 0.55
# --- Self-Play Training Configuration ---
NUM_SIMULATIONS_TRAIN = 64#1600
